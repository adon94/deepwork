...
Navigation.startSingleScreenApp({
    screen: {
        ...
        navigatorStyle: { navBarHidden: true, statusBarColor: colors.tigerOrange, statusBarTextColorScheme: 'dark' },//statusBarHidden: true }, // override the navigator style for the screen, see 'Styling the navigator' below (optional)
